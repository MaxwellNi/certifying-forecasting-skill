...
The [support summary](directional_support.csv) reports each channel's fallback and unseen-entity shares. Run `python summarize_support.py` in this directory to reconstruct it. These shares document rows outside the directional centering assumptions; they do not repair calibration.
