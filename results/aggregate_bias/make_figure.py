...
ax.set_ylabel("Ratio of median slacks", labelpad=2)
...
record = {
    ...
    "right_panel": "All 72 known-category-probability validation settings; each point is rectangle/aggregate within-setting median slack over 2,000 repetitions per method.",
    "right_axis_label": "Ratio of median slacks",
