...
def main():
    ...
    peer_path = args.data_root/'results/design_validation/peer_sampling.csv'
    learned_path = args.data_root/'results/learned_references/summary.csv'
    ...
    plt.rcParams.update({'font.family':'Liberation Serif','font.size':8.5,
        'axes.titlesize':8.5,'axes.labelsize':8.5,'legend.fontsize':8.5,
    ...
    fig, axes = plt.subplots(1,4,figsize=(7.0,2.18),sharey=True)
    fig.subplots_adjust(left=.068,right=.991,bottom=.23,top=.68,wspace=.22)
