...
The final-target module includes the unchanged UCI [News Popularity in Multiple
Social Media Platforms dataset](https://archive.ics.uci.edu/dataset/432/news+popularity+in+multiple+social+media+platforms),
by Luís Torgo and Nuno Moniz (2018), DOI 10.24432/C5H029, under
[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). The source ZIP is
unchanged; derived first-hour features, fixed stage labels and forecast arrays
are research transformations. This data license is separate from the software
license. Full attribution and transformation scope are recorded in
`results/target_precision/data/DATA_LICENSE.md`.

Beijing PM2.5: unchanged UCI source ZIP, CC BY 4.0, creator Song Chen. See the [license and transformations](results/trajectory_forecast/DATA_LICENSE.md).
